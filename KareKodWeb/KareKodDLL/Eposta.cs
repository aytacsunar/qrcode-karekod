...
namespace KareKodDLL
{
    class Eposta
    {
        ...
        public Eposta()
        {
            GonderenMail = "karekod@gmail.com"; //gmail adresiniz
            GonderenSifre = "karelikod"; //gmail sifreniz
            SunucuPort = 587; //port no 587 veya 21
            SunucuGuvenlikDurumu = true; 
            SunucuAdi = "smtp.gmail.com"; 
            GonderenAdi = "KareKodWeb"; // gönderen adi!
        }
